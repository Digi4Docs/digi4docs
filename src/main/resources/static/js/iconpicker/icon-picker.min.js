...
!function (e, t) {
    ...
    return (() => {
        ...
        function n(e, t, n, i) {
            ...
            for (const s of t) for (const t of n) s[e](t, i);
        ...
        function a(e, t) {
            ...
            return r(e) && r(t) && Object.keys(t).forEach((i => {
                r(t[i]) ? i in e ? n[i] = a(e[i], t[i]) : Object.assign(n, {[i]: t[i]}) : Object.assign(n, {[i]: t[i]})
            })), n
        }
        ...
        const d = "https://raw.githubusercontent.com/iconify/collections-json/master/json", u = {
            "Material Design Icons": {key: "mdi", prefix: "mdi mdi-", url: `${d}/mdi.json`},
            "FontAwesome Brands 5": {key: "fa-brands", prefix: "fab fa-", url: `${d}/fa-brands.json`},
            "FontAwesome Solid 5": {key: "fa-solid", prefix: "fas fa-", url: `${d}/fa-solid.json`},
            "FontAwesome Regular 5": {key: "fa-regular", prefix: "far fa-", url: `${d}/fa-regular.json`},
            "FontAwesome Solid 6": {key: "fa6-solid", prefix: "fa-solid fa-", url: `${d}/fa6-solid.json`},
            "FontAwesome Regular 6": {key: "fa6-regular", prefix: "fa-regular fa-", url: `${d}/fa6-regular.json`},
            Iconoir: {key: "iconoir", prefix: "iconoir-", url: `${d}/iconoir.json`}
        };
        ...
        class m {
            ...
            _eventListener = {select: [], save: [], show: [], hide: []};
            ...
            _preBuild() {
                var e;
                this.element = (e = this.element) instanceof HTMLElement ? e : "string" == typeof e ? document.querySelector(e) : null, this.root = l(this.options), !Array.isArray(this.options.iconSource) && this.options.iconSource.length > 0 && (this.options.iconSource = [this.options.iconSource])
            }
            ...
            _binEvents() {
                ...
                let s = [];
                var r, a, c;
                this._eventBindings = [i(n, "click", (() => this.show())), i(t.close, "click", (() => this.hide())), i(t.modal, "click", (e => {
            ...
            async _renderdIcons() {
                ...
                if (this.availableIcons = [], e.content.innerHTML = "", (await this._getIcons()).forEach((s => {
                    ...
                    let e = document.querySelector(`[data-value="${t.defaultValue ? t.defaultValue : this.element.value}"]`) ? document.querySelector(`[data-value="${t.defaultValue ? t.defaultValue : this.element.value}"]`) : document.querySelector(`.${t.defaultValue ? t.defaultValue : this.element.value}`),
                        i = e.dataset.value;
                    e.classList.add("is-selected"), n = e, this.currentlySelectName = i, this.element.value || this._setValueInput()
                }
            }
            ...
            async _getIcons() {
                ...
                for (const e of Object.values(n)) t.push(e.url);
